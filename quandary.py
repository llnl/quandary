...
class Quandary:
    ...
    solver_type            : str  = "tao_bfgs" # "tao_bfgs", "tao_hessian", or "rol"
    rol_input              : str  = "./rolinput.xml"
    hessian_rff_ncut       : int = -1
    hessian_rff_nextra     : int = 10
    hessian_rff_positive_evals_only   : bool = False
    ...
    def __dump(self, *, pcof0=[], runtype="simulation", datadir="./run_dir"):
        ...
        lines.append(f"solver_type = {_toml_str(self.solver_type)}")
        if self.solver_type.lower() == "rol":
            lines.append(f"rol_input = {_toml_str(self.rol_input)}")
        lines.append("hessian_rff = { ncut = " + str(self.hessian_rff_ncut) + ", nextra = " + str(self.hessian_rff_nextra) + ", positive_evals_only = " + str(self.hessian_rff_positive_evals_only).lower() + " }")
