...
class Quandary:
    ...
    def __dump(self, *, pcof0=[], runtype="simulation", datadir="./run_dir"):
        ...
        lines.append("penalty = { leakage = " + str(self.gamma_leakage) + ", energy = " + str(self.gamma_energy) + ", dpdm = " + str(self.gamma_dpdm) + ", variation = " + str(self.gamma_variation) + ", weightedcost = 0.0, weightedcost_width = 0.0, robust = " + str(self.gamma_robust) + " }")
    ...
    def get_results(self, *, datadir="./", ignore_failure=False):
        ...
        optim_hist = {
            ...
            # "Penalty-Robust"         : optim_hist_tmp[:,10],
        }
