...
/** 
 * @brief Types of optimization solver *
 */
enum class OptimSolverType {
  TAO_BFGS,     ///< Petsc's TAO BFGSoptimizer
  TAO_HESSIAN,  ///< Petsc's TAO Hessian optimizer
  ROL           ///< Sandia's ROL optimizer
};
const std::map<std::string, OptimSolverType> OPTIM_SOLVER_TYPE_MAP = {
    {"tao_bfgs", OptimSolverType::TAO_BFGS},
    {"tao_hessian", OptimSolverType::TAO_HESSIAN},
    {"rol", OptimSolverType::ROL}
};
